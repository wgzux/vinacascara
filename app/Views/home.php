...
<section class="hero" id="hero">
  ...
  <div class="hero-content">
    ...
    <div class="hero-stats">
      ...
      <div class="stat-divider"></div>
      <div class="hero-stat"><span class="stat-number">Tự nhiên</span><span class="stat-label">Không phụ gia</span>
      </div>
    </div>
  </div>
            ...
            <div class="swiper product-swiper" id="swiper-<?= $product['id'] ?>">
              <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    <img src="<?= e($img['image_url']) ?>" alt="<?= e($img['alt_text'] ?? $product['name']) ?>"
                      loading="lazy">
                  </div>
                  <?php endforeach; ?>
              </div>
    ...
    <div class="about-grid">
      <div class="about-image-wrap">
        <div class="about-image-frame">
          <img src="/assets/images/about-tea.png" alt="Về Vina Cascara" loading="lazy">
        </div>
      </div>
  ...
  <div class="container">
    <div class="contact-inner">
      <div class="contact-content">
        ...
        <p class="contact-desc">Để lại thông tin, chúng tôi sẽ hướng dẫn bạn cách pha cascara ngon nhất và tư vấn sản
          phẩm phù hợp.</p>
      </div>
